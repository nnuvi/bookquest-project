...
const books: Book[] = [
  { id: '1', title: 'Book 1', author: 'Author 1', image: 'https://example.com/book1.jpg', dateLent: '2024-11-10' },
  { id: '2', title: 'Book 2', author: 'Author 2', image: 'https://example.com/book2.jpg', dateLent: '2024-10-25' },
];
  ...
  const renderBookItem = ({ item }: { item: Book }) => (
    <View style={styles.bookItem}>
      ...
      <View style={styles.bookDetails}>
        ...
        <Text style={styles.bookDate}>Lent on: {item.dateLent}</Text>
      </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.navBar}>
        ...
        <TouchableOpacity>
          <Text style={[styles.navItem, styles.highlighted]}>Lent</Text>
        </TouchableOpacity>
        <TouchableOpacity>
